...
$account = Account::getInstance()->getOneBy(["id"], [$_COOKIE["id"]]);
?>
<!DOCTYPE html>
<html lang="zh">
    ...
    <div class="info-box">
        <form role="form" id="form">
            ...
            <div class="form-group">
                ...
                <div><?php echo $account["create_time"]; ?></div>
            </div>
